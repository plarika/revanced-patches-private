...
EXPECTED_BASE = "09afcf3e44d6d8c98810b1cbf6f39477f9bcae66"
...
required = [
    ...
    ROOT / ".fantamk" / "UPSTREAM_WATCH.md",
    ROOT / ".fantamk" / "upstream_baseline.json",
    ROOT / ".fantamk" / "watch_upstream.py",
    ROOT / ".github" / "workflows" / "watch_upstream.yml",
